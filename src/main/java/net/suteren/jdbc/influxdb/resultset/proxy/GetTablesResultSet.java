...
public class GetTablesResultSet extends AbstractProxyResultSet {
	public GetTablesResultSet(InfluxDbConnection influxDbConnection, String tableNamePattern) throws SQLException {
		super(influxDbConnection.createStatement().executeQuery(String.format("SHOW MEASUREMENTS%s",
			...
			new String[] { null, null, null, "TABLE", null, null, null, null, null, null });
	}
