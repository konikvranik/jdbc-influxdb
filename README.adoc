...
[influxdb-jdbc artifact](https://central.sonatype.com/artifact/net.suteren.jdbc.influxdb/influxdb-jdbc) is hosted on [Maven Central](https://central.sonatype.com/)
